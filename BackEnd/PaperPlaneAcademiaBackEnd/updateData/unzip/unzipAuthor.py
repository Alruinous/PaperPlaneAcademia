...
# 将遍历到的 .gz 文件路径保存到 processed_authors_gz.txt
...
def start_monitoring(local_dir):
    processed_file = "/root/openalex-snapshot/data/processed_authors_gz.txt"  # 存储已处理 .gz 文件路径的文件
...
# 示例调用
local_dir = "/root/openalex-snapshot/data/authors"  # 本地文件夹路径
